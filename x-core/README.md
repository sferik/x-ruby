...
It handles OAuth 1.0a, OAuth 2.0 with token refresh, and bearer tokens. It also handles redirects, proxies, timeouts, HTTP errors, rate limits, and streaming. It depends only on the `base64` gem. Media uploads live in [`x-media`](../x-media).
