...
module X
  class MediaPathnameTest < Minitest::Test
    ...
    def test_upload_of_an_image_at_a_pathname
      ...
      assert_equal TEST_MEDIA_ID, Uploader::Media.upload(Pathname("test/sample_files/sample.png"), client: @client)["id"]
    end
    ...
    def test_upload_of_a_video_at_a_pathname
      ...
      assert_equal TEST_MEDIA_ID, Uploader::Media.upload(path, client: @client)["id"]
