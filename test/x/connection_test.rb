...
module X
  ...
  class ConnectionTest < Minitest::Test
    def setup
      @connection = Connection.new(base_url: "https://api.twitter.com/2/", open_timeout: 10, read_timeout: 10,
        write_timeout: 10)
    end
    ...
    def test_that_proxy_url_is_set_on_the_http_client
      connection = Connection.new(proxy_url: "https://proxy.com:42")
    ...
    def test_that_authenticated_proxy_url_is_set_on_the_http_client
      connection = Connection.new(proxy_url: "https://user:pass@proxy.com")
