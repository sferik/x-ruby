...
module X
  class PageTest < Minitest::Test
    ...
    def setup
      ...
      @page = Page.new(items: @users, meta: {next_token: "abc", result_count: 2})
    end
    ...
    def test_each
      assert_equal %w[1 2], @page.map(&:id)
    ...
    def test_next_token
      ...
      assert_nil Page.new(items: [], meta: {}).next_token
    end

    def test_result_count
      assert_equal 2, @page.result_count
      assert_nil Page.new(items: [], meta: {}).result_count
    end
  end
end
