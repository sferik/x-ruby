...
module X
  class PostAttributesTest < Minitest::Test
    ...
    ATTRS = {"id" => "1", "text" => "hi", "lang" => "en", "source" => "app", "created_at" => "2024-01-02T03:04:05.000Z",
             ...
             "reply_settings" => "everyone", "edit_history_tweet_ids" => ["1"], "edit_controls" => {"editable_until" => "x"},
             ...
             "withheld" => {"copyright" => true}, "note_tweet" => {"text" => "long"},
    ...
    def test_class_configuration
      ...
      assert_equal "tweets", Post.includes_key
      assert_same Post, Tweet
    end

    def test_default_params
      expected = {"tweet.fields" => Post::FIELDS, "user.fields" => User::FIELDS, "media.fields" => Media::FIELDS,
    ...
    def test_note_and_metrics_hash
      ...
      assert_equal 1, @post.public_metrics["retweet_count"]
      assert_equal [{"type" => "replied_to", "id" => "5"}], @post.referenced_tweets
    end
